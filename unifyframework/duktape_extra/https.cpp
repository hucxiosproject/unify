...
//  unifyframework
//
//  Created by huchangxing on 16/5/13.
...
static int jsb_httpRequest_put_post(duk_context* ctx, const char* method) {
    ...
    ce::HttpsRequest::createRequest(url, NULL, postData, method, listener)->start();
    return 0;
}
...
static int jsb_httpRequest_get_delete(duk_context* ctx, const char* method) {
    ...
    ce::HttpsRequest::createRequest(url, NULL, NULL, method, listener)->start();
    return 0;
}
